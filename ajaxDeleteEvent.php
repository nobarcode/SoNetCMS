...
while ($row = mysql_fetch_object($result)) {
	...
	mysql_query("DELETE FROM documentVersioning WHERE parentId = '{$row->id}' AND documentType = 'eventImage'");
	
}

//delete the document's image gallery
mysql_query("DELETE imagesEvents FROM imagesEvents WHERE imagesEvents.parentId = '{$id}'");
