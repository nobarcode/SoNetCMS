...
if ($count > 0) {
	...
	print "<div class=\"editor_featured_document_container\">";
	print "<form id=\"edit_featured_document_options_form\" method=\"get\" action=\"ajaxUpdateFeaturedDocumentOptions.php\">\n";
	...
	print "<tr valign=\"center\"><td class=\"options_editor_container\" colspan=\"2\"><input type=\"submit\" id=\"submit\" value=\"Save\"> <input type=\"button\" id=\"edit_featured_document_options_cancel\" value=\"Cancel\"></td></tr>\n";
	print "</table>\n";
