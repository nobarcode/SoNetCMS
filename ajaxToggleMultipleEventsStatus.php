...
for ($x = 0; $x < count($toggleStatusId); $x++) {
	...
	mysql_query("UPDATE events SET publishState = IF(publishState = 'Unpublished', 'Published', IF(publishState = 'Published', 'Unpublished', publishState)) WHERE id = '{$toggleStatusId[$x]}'");
