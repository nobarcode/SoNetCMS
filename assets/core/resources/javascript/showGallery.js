	...
	if (page < totalPages) {
		...
		if (highestPageRequested < page) {
			...
			$.ajax({
				...
				type: 'post',
				dataType: 'html',
				data: {parentId: parentId, requestedPage: page, type: 'document'}
...
function showImage(imageId) {
	...
	$('#main_content_container').fadeTo(500, 0.0, function() {
		...
		$.ajax({
			...
			url: '/ajaxShowGalleryMainContent.php',
			type: 'post',
			dataType: 'html',
...
function regenerateCommentsList(s, d) {
	...
	$.ajax({
		...
		type: 'post',
		dataType: 'html',
		data: {parentId: parentId, id: imageId, type: 'documentImageComment', commentFilter: $('#commentFilter').val(), s: s, d: d}
...
function editComment(commentId) {
	...
	$.ajax({
		...
		type: 'post',
		dataType: 'script',
		data: {id: commentId, value: $('#comment_edit').val(), type: 'documentImageComment'}
...
function deleteComment(commentId) {
	...
	$.ajax({
		...
		type: 'post',
		dataType: 'text',
		data: {id: commentId, type: 'documentImageComment'}
