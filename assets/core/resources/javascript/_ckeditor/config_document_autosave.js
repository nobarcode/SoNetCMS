...
CKEDITOR.editorConfig = function( config )
{
	...
	[
    ['AutoSave','AjaxSave','AjaxSaveAs','NewPage','SonetPreview','-','SonetTemplateChooser'],
	...
	config.extraPlugins = 'sonet_autosave,sonet_ajaxsave,sonet_ajaxsaveas,sonet_preview,sonet_template_chooser,iframe,sonet_component,sonet_rc_component,sonet_auth_content,sonet_group_content,sonet_toggler,sonet_smartlink,sonet_document_attribute'; 	
};