...
CKEDITOR.plugins.add('sonet_document_attribute_blog', {
	
	init: function(editor) {
		
		var pluginName = 'sonet_document_attribute_blog';
		...
		editor.ui.addButton('DocumentAttributeBlog', {
			
			label : "Insert Document Attribute",
			command : pluginName,
			icon : "/assets/core/resources/javascript/ckeditor/plugins/sonet_document_attribute_blog/document_attribute.png"
