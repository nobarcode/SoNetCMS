...
CKEDITOR.editorConfig = function( config )
{
	...
	config.serverPreviewURL = '/previewEvent.php';
	config.templates_files = ['/assets/core/resources/templates/events/event_templates.js'];
	...
	[
    ['AjaxSave','NewPage','SonetPreview','-','Templates'],
    ['Print', 'SpellChecker', 'Scayt'],
    ['SelectAll','Cut','Copy','Paste','PasteText','PasteFromWord'],
    ['Undo','Redo','-','Find','Replace'],
    ['Source','-','Maximize', 'ShowBlocks'],
    ['DocumentAttributeEvent'],
    '/',
	...
	config.extraPlugins = 'sonet_ajaxsave,sonet_preview,sonet_document_attribute_event'; 	
};
