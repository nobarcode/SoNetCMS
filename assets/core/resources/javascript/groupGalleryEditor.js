function objectSortableOn() {
	...
	$('#images_list').sortable({
		...
		update: function() {
			...
			values += '&groupId=' + groupId + '&s=' + last_s;
			
			$.ajax({
				url: '/ajaxChangeGroupImageOrder.php',
				type: 'post',
				dataType: "script",
				data: values
...
function toggleInSeries(imageId) {
	...
	$.ajax({
		...
		url: '/ajaxToggleInSeriesGroupImage.php',
		type: 'post',
		dataType: 'text',
		data: {groupId: groupId, imageId: imageId}
...
function editImage(imageId) {
	...
	$.ajax({
		...
		url: '/ajaxLoadGroupImageInfo.php',
		type: 'post',
		dataType: 'script',
		data: {groupId: groupId, imageId: imageId}
...
function regenerateList(s, d) {
	...
	$.ajax({
		...
		url: '/ajaxGroupGalleryEditor.php',
		type: 'post',
		dataType: 'html',
