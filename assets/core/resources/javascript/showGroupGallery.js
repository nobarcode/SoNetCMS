	...
	if (page < totalPages) {
		...
		if (highestPageRequested < page) {
			...
			$.ajax({
				...
				type: 'post',
				dataType: 'html',
				data: {parentId: parentId, requestedPage: page, type: 'group'}
...
function showImage(imageId) {
	...
	$('#main_content_container').fadeTo(500, 0.0, function() {
		...
		$.ajax({
			...
			url: '/ajaxShowGroupGalleryMainContent.php',
			type: 'post',
			dataType: 'html',
...
function regenerateCommentsList(s, d) {
	...
	$.ajax({
		...
		type: 'post',
		dataType: 'html',
		data: {parentId: parentId, id: imageId, type: 'groupImageComment', commentFilter: $('#commentFilter').val(), s: s, d: d}
...
function editComment(commentId) {
	...
	$.ajax({
		...
		type: 'post',
		dataType: 'script',
		data: {id: commentId, value: $('#comment_edit').val(), type: 'groupImageComment'}
...
function deleteComment(commentId) {
	...
	$.ajax({
		...
		type: 'post',
		dataType: 'text',
		data: {id: commentId, type: 'groupImageComment'}
